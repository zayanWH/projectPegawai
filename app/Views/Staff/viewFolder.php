        ...
        <div class="flex items-center space-x-2 text-xl font-semibold text-gray-800">
            ...
            <?php if (!empty($breadcrumbs)): ?>
                <?php foreach ($breadcrumbs as $breadcrumb): ?>
                    ...
                    <a href="<?= site_url('staff/folder/' . $breadcrumb['id']) ?>" class="text-blue-600 hover:text-blue-800"><?= esc($breadcrumb['name']) ?></a>
                <?php endforeach; ?>
            <?php endif; ?>
        </div>
            ...
            <?php foreach ($subFolders as $subFolder): ?>
                <tr class="hover:bg-gray-50 item-with-context-menu"
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <a href="<?= base_url('staff/folder/' . $subFolder['id']) ?>" class="block h-full w-full text-sm text-gray-900 hover:text-blue-700 hover:underline">
