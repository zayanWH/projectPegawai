...
<body class="bg-gray-200">
    <header class="fixed top-0 left-0 right-0 bg-white shadow-md z-10 h-16 flex items-center justify-between px-6">
        ...
        <div class="flex items-center space-x-4">
            <a href="<?= site_url('direksi/download-file/' . $fileId) ?>" title="Unduh File" aria-label="Unduh File" class="text-gray-600 hover:text-gray-900" download>
    ...
    <main>
        <iframe src="<?= site_url('direksi/serve-file/' . $fileId) ?>" class="w-full h-screen pt-16" frameborder="0" title="Tampilan File: <?= esc($fileName) ?>"></iframe>
    </main>
