...
<div class="bg-white rounded-lg shadow-sm p-6 mb-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div class="relative flex-grow">
            ...
            <input type="text" id="searchUser" name="search_user" placeholder="Cari nama atau email user..."
        ...
        <form method="GET" class="flex flex-wrap items-center gap-4 md:ml-auto">
            <button type="button" id="openAddUserModal"
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200" id="userTableBody">
                    ...
                    <?php foreach ($users as $user): ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button type="button"
                                    class="inline-flex items-center text-yellow-500 hover:text-yellow-700 mr-3 open-edit-user-modal"
                                    data-user-id="<?= esc($user['id']) ?>">
                                    <img src="<?= base_url('images/edit.png') ?>" alt="Folder Icon" class="w-5 h-5 mr-2">
                                </button>
                                <button type="button"
                                    class="inline-flex items-center text-red-500 hover:text-red-700 open-delete-user-modal"
                                    data-user-id="<?= esc($user['id']) ?>">
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="6" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">Tidak ada data
                            user.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
    ...
    <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-md transition-all duration-300 ease-in-out">
        ...
        <form id="addUserForm">
            <div class="mb-4">
                ...
                <input type="text" id="addNamaLengkap" name="name" placeholder="Masukan nama lengkap"
            ...
            <div class="mb-4">
                ...
                <input type="email" id="addEmail" name="email" placeholder="abcd@gmail.com"
                    class="w-full border rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <input type="password" id="addPassword" name="password" placeholder="Masukan password"
                        class="w-full border rounded-lg px-3 py-2 pr-10 focus:ring-blue-500 focus:border-blue-500">
                    <button type="button"
                        class="absolute inset-y-0 right-0 flex items-center text-gray-500 toggle-password-visibility">
                    </button>
                </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <select id="addJabatan" name="role_id"
                        class="w-full border rounded-lg px-3 py-2 pr-10 appearance-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    <select id="addStatus" name="is_active"
                        class="w-full border rounded-lg px-3 py-2 pr-10 appearance-none focus:ring-blue-500 focus:border-blue-500">
            ...
            <div class="flex justify-end space-x-4">
                <button type="button" id="cancelAddUserModal"
    ...
    <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-md transition-all duration-300 ease-in-out">
        ...
        <form id="editUserForm">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="editNamaLengkap" name="name"
                    class="w-full border rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="editPassword" class="block text-sm font-medium text-gray-700 mb-1">Password (Kosongkan jika
                    tidak ingin diubah)</label>
                <div class="relative">
                    <input type="password" id="editPassword" name="password"
                        class="w-full border rounded-lg px-3 py-2 pr-10 focus:ring-blue-500 focus:border-blue-500">
                    <button type="button"
                        class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 toggle-password-visibility">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    <select id="editJabatan" name="role_id"
                        class="w-full border rounded-lg px-3 py-2 pr-10 appearance-none focus:ring-blue-500 focus:border-blue-500">
