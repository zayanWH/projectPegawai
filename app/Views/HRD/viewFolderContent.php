...
<div class="bg-white rounded-lg shadow-sm p-6 mb-6">
    <div class="flex items-center justify-between">
        <div class="flex items-center space-x-2 text-xl font-semibold text-gray-800">
            <a href="<?= site_url('hrd/dokumen-staff') ?>" class="text-blue-600 hover:text-blue-800">Dokumen Saya</a>
    ...
    <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-md transition-all duration-300 ease-in-out">
        ...
        <form id="uploadFileForm" enctype="multipart/form-data">
            ...
            <div class="flex justify-end space-x-4 mt-6">
                <button type="button" id="cancelUploadFileModal" class="text-blue-500 hover:text-blue-700">Batal</button>
                <button type="submit" id="submitUploadFile" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md">Upload</button>
            </div>
        </form>
    </div>
</div>
