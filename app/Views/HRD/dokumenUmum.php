        ...
        <form id="createFolderForm">
            ...
            <div id="sharedOptions" class="hidden mb-4">
                <div class="grid grid-cols-2 gap-2 mb-4">
                    ...
                    <label><input type="checkbox" name="access_roles[]" value="Supervisor" class="mr-2">
                        Supervisor</label>
                ...
                <div class="relative mb-4">
                    <select id="sharedType" name="shared_type"
                        class="w-full border rounded-lg px-3 py-2 pr-10 appearance-none">
    ...
    <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-md transition-all duration-300 ease-in-out">
        ...
        <form id="uploadFileForm" enctype="multipart/form-data">
            ...
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit"
                    class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg font-semibold">Upload</button>
            </div>
        </form>
    </div>
</div>
                ...
                <?php if (!empty($documents)): ?>
                    <?php foreach ($documents as $doc): ?>
                        <?php if ($doc['type'] === 'folder'): ?>
                            <tr class="hover:bg-gray-50" data-item-type="folder" data-folder-id="<?= esc($doc['id']) ?>">
                            <?php else: ?>
                            <tr class="hover:bg-gray-50" data-item-type="file" data-file-id="<?= esc($doc['id']) ?>">
                            <?php endif; ?>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <?php if ($doc['type'] === 'folder'): ?>
                                        <img src="<?= base_url('images/folder.png') ?>" alt="Folder Icon" class="w-5 h-5 mr-3">
                                    <?php else: ?>
                                        <?php
                                        ...
                                        ?>
                                        <img src="<?= $iconSrc ?>" alt="File Icon" class="w-5 h-5 mr-3">
                                    <?php endif; ?>
                                    <div>
                                        <?php if ($doc['type'] === 'folder'): ?>
                                        ...
                                        <?php if (!empty($doc['category'])): ?>
                                            <span
                                                class="ml-2 px-2 py-1 text-xs bg-gray-100 text-gray-600 rounded"><?= esc($doc['category']) ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <button onclick="toggleMenu(this)" class="text-gray-600 hover:text-gray-900">⋮</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
