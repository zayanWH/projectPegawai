        ...
        <ul class="space-y-1 text-base flex-1">
            ...
            <li>
                <a href="<?= site_url('admin/manajemen-user') ?>" class="flex items-center gap-4 text-white hover:bg-[#2B364F] hover:text-white rounded-md px-3 py-3 transition">
                    <img src="<?= base_url('images/users.png') ?>" alt="Dokumen Staff Icon" class="w-6 h-6 filter invert">
            ...
            <li>
                <a href="<?= site_url('admin/manajemen-jabatan') ?>" class="flex items-center gap-4 text-white hover:bg-[#2B364F] hover:text-white rounded-md px-3 py-3 transition">
                    <img src="<?= base_url('images/id-card.png') ?>" alt="Dokumen Bersama Icon" class="w-6 h-6 filter invert">
            ...
            <li>
                <a href="<?= site_url('admin/monitoring-storage') ?>" class="flex items-center gap-4 text-white hover:bg-[#2B364F] hover:text-white rounded-md px-3 py-3 transition">
                    <img src="<?= base_url('images/cloud-computing.png') ?>" alt="Dokumen Umum Icon" class="w-6 h-6 filter invert">
