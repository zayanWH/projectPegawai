...
<body class="bg-gray-100 font-poppins">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <header class="fixed top-0 left-0 right-0 bg-white shadow-sm z-30 md:hidden">
            <div class="flex items-center justify-between px-4 py-3">

                <?php
                $backButtonContent = $this->renderSection('showBackButton', false);
                if (!empty($backButtonContent)):
                    ?>
                    <a href="#" onclick="window.history.back(); return false;" class="p-1 rounded-md text-gray-700">
                ...
                <?php else: ?>
                    <button id="hamburger-btn" class="p-1 rounded-md text-gray-700">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                ...
                <div class="flex-1 text-center font-semibold text-lg text-gray-800">
                    <?= $this->renderSection('pageTitle') ?>
                </div>
                <div class="flex-shrink-0 ml-auto">
                    <?= $this->renderSection('pageLogo') ?>
                </div>
            </div>
        </header>

        <aside id="sidebar" class="w-64 bg-[#161F32] flex flex-col h-screen fixed inset-y-0 left-0 z-50
                                    transform -translate-x-full md:translate-x-0 md:flex
            ...
            <a href="<?= site_url('logout') ?>"
                class="bg-red-600 hover:bg-red-700 text-white text-center font-medium py-2 rounded-md mx-4 mb-4">
                Logout
                </a>
        </aside>
    ...
    <div id="floatingMenu"
        ...
        <ul class="text-sm text-gray-700 divide-y divide-gray-100">
            <li id="renameOption" onclick="showRenameModal()"
                ...
                <img src="<?= base_url('images/edit.png') ?>" alt="Rename Icon" class="w-5 h-5 mr-3 text-gray-600">
                Ganti nama
            </li>

            <li id="infoDetailOption" onclick="showInfoDetailModal()"
                class="flex items-center px-4 py-3 hover:bg-gray-100 cursor-pointer">
                <img src="<?= base_url('images/infoo.png') ?>" alt="Info Icon" class="w-5 h-5 mr-3 text-gray-600">
                Informasi detail
            </li>
            ...
            <li id="deleteOption" onclick="showDeleteConfirmModal()"
                ...
                <img src="<?= base_url('images/delete.png') ?>" alt="Delete Icon" class="w-5 h-5 mr-3">
                Hapus
            </li>
        </ul>
    </div>
